...
class ChessBoard {
 ...
 late ChessPiece player1King;
 late ChessPiece player2King;
 late ChessPiece? enPassantPiece;
...
MoveMeta push(Move move, ChessBoard board,
  ...
  var mso = MoveStackObject(move, board.tiles[move.from] as ChessPiece, board.tiles[move.to] as ChessPiece,
      board.enPassantPiece as ChessPiece, List.from(board.possibleOpenings));
